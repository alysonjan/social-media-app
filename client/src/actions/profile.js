...
import { GET_PROFILE, PROFILE_ERROR, UPDATE_PROFILE, CLEAR_PROFILE, ACCOUNT_DELETED, GET_PROFILES, GET_REPOS } from "./constant";
...
export const addExperience = (formData, history) => async dispatch => {
    try {
        const res = await axiosInstance.put('/api/profile/experience', formData)
        dispatch({
            type: UPDATE_PROFILE,
            payload: res.data
        });
...
export const addEducation = (formData, history) => async dispatch => {
    try {
        const res = await axiosInstance.put('/api/profile/education', formData)
        dispatch({
            type: UPDATE_PROFILE,
            payload: res.data
        });
